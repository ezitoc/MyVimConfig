...
hi Folded       term=NONE cterm=NONE ctermfg=Darkgray    ctermbg=Black
hi Ingore       term=NONE cterm=NONE ctermfg=Darkgray    ctermbg=Black
hi Conditional  term=BOLD cterm=BOLD ctermfg=DarkGreen   ctermbg=Black
hi Repeat       term=BOLD cterm=BOLD ctermfg=DarkGreen   ctermbg=Black
